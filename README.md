# Strom_Aura
Strom Aura is a thermoelectric energy harvesting system that converts heat into electrical energy using the principle of the Seebeck Effect.
The project demonstrates how waste heat can be utilized to generate usable power.
